...
def home():
    ...
    json_folder = "/content/json"  # Replace "/json" with the actual path of your "json" folder
...
def parse_paper_with_science_parse(pdf_file_path, output_folder):
    jar_file_path = '/content/science-parse-cli-assembly-2.0.3.jar'
...
def title_page(title):
    ...
    # Add a "View PDF" button to download the PDF file
        pdf_path = os.path.join("/content/arxiv", f"{title}.pdf")
